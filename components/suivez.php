<section class="section">
  ...
  <div class="content">
    <h2 class="title" data-text="SUIVEZ-NOUS">SUIVEZ-NOUS</h2>
    ...
    <p class="desc">Découvrez les coulisses de notre cuisine et de nos créations</p>

    <div class="video-container">
        <iframe src="https://www.youtube.com/embed/qHSmSG_VoKA"
    ...
    <div class="socials">
      ...
      <a class="btn" href="https://facebook.com/hiroshiresto" target="_blank">
        <div class="corner-deco"></div>
        <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
        <span>@hiroshiresto</span>
      </a>

      <a class="btn" href="https://instagram.com/hiroshiresto" target="_blank">
        <div class="corner-deco"></div>
      ...
      <a class="btn" href="https://tiktok.com/@hiroshiresto" target="_blank">
        <div class="corner-deco"></div>
